...
Java_rext_org_rextwallet_AndroidJniBridge_compute1024seedNative(JNIEnv *env, jobject instance,
                                                                jbyteArray seed) {
    try{
...
Java_rext_org_rextwallet_AndroidJniBridge_computeVSeedAndVExpandedNative(JNIEnv *env,
                                                                         jobject instance) {
