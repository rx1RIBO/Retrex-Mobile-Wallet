...
import static rext.org.rextwallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(RextModule rextModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(rextModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = RextApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String rextUri = RextURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(rextUri,address.toBase58());
            }
    ...
    public void setModule(RextModule module) {
        this.module = module;
    }
