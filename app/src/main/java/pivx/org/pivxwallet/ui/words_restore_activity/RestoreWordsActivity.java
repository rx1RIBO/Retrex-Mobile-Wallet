package rext.org.rextwallet.ui.words_restore_activity;
...
import org.rextj.crypto.MnemonicException;
...
import rext.org.rextwallet.ui.transaction_send_activity.MyFilterableAdapter;
import rext.org.rextwallet.ui.transaction_send_activity.MyTextWatcher;
...
import static rext.org.rextwallet.module.RextContext.REXT_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = rextModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            rextModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            rextModule.restoreWallet(mnemonic, REXT_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (rextApplication.getAppConf().getPincode() != null){
                                                        ...
                                                        if(!rextApplication.getAppConf().isAppInit()){
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, RextContext.ENABLE_BIP44_APP_VERSION));
