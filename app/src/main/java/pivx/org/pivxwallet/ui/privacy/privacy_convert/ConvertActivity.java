package rext.org.rextwallet.ui.privacy.privacy_convert;
...
public class ConvertActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        View headerView = getLayoutInflater().inflate(R.layout.fragment_rext_amount, header_container);
        ...
        btn_add_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                edit_amount.setText(rextModule.getZpivAvailableBalanceCoin().toPlainString());
            }
        });
        ...
        edit_amount.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > 0) {
                    ...
                    if (rextRate != null)
                        txt_amount_local.setText("0 "+rextRate.getCode());
                    else
                        txt_amount_local.setText(R.string.no_rate);
                }
            }
    ...
    private void reconvertProcess(Coin coin) throws InsufficientMoneyException {
        ...
        Address address = rextModule.getReceiveAddress();
        SendRequest sendRequest = rextModule.createSpend(address, coin, true);
    ...
    private void mintProcess(Coin coin) throws InsufficientMoneyException {
        final SendRequest sendRequest = rextModule.createMint(coin);
                    ...
                    public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                        new Thread(() -> {
                            ...
                            try {
                                ...
                                rextModule.commitTx(tx);
                                Intent intent = new Intent(ConvertActivity.this, RextWalletService.class);
