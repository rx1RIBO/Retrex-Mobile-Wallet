package rext.org.rextwallet.ui.export_account;
...
import org.rextj.crypto.DeterministicKey;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = rextModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(RextContext.NETWORK_PARAMETERS);
