package rext.org.rextwallet.ui.transaction_request_activity;
...
import rext.org.rextwallet.ui.transaction_send_activity.AmountInputFragment;
import rext.org.rextwallet.utils.DialogsUtil;
import rext.org.rextwallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static rext.org.rextwallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static rext.org.rextwallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = rextModule.getFreshNewAddress().toBase58();

        NetworkParameters params = rextModule.getConf().getNetworkParams();

        String rextURI = RextURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(rextURI);
        qrDialog.setQrText(rextURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String rextURI) throws WriterException {
