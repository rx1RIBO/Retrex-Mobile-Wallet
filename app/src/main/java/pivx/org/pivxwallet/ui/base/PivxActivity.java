...
import static rext.org.rextwallet.service.IntentsConstants.ACTION_STORED_BLOCKCHAIN_ERROR;
import static rext.org.rextwallet.service.IntentsConstants.ACTION_TRUSTED_PEER_CONNECTION_FAIL;

/**
 * Created by furszy on 6/8/17.
 */

public class RextActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (isCoreNeeded()) {
            if (!rextApplication.isCoreStarted()) {
