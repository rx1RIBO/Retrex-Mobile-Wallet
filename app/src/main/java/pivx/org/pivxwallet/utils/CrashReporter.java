...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final RextApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (RextContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + RextContext.NETWORK_PARAMETERS.getId() + "\n");



		final MultiWallet multiWallet = ((RextModuleImp)application.getModule()).getWallet();
