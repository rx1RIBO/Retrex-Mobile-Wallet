...
public class CoinMarketCapApiClient {
    ...
    public class RextMarket{
        ...
        public RextMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public RextMarket getRextPxrice() throws RequestRextRateException{
        try {
            RextMarket rextMarket = null;
            String url = this.URL + "ticker/rext/";
            ...
            e.printStackTrace();
            throw new RequestRextRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestRextRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestRextRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestRextRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
